...
public class LiaotianFrame extends JFrame implements WindowListener {
	 ...
	 * Create the frame
	 */
	public LiaotianFrame(final String uidStr, String netnameStr, String imageStr, String infoStr,Vector<Msg> msgs) {
		super();
		this.uidStr = uidStr;
		...
		ImageIcon imageIcon = new ImageIcon("image1/" + imageStr + ".png");
		...
		netnameLabel.setFont(new Font("΢���ź�", Font.BOLD, 14));
